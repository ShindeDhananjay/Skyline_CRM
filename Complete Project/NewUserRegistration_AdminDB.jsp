...
<body>
    ...
    <h1 class="main_heading">New User registration</h1>
    <center>
            <form id="form1" class="well" name="f1" method="post" action="NewUserRegistration_AdminDB_Process.jsp">
            <div class="row">
            ...
            <div class="form-group row">
                <label class="col-sm-2">Type Of User</label>
                                <div class="radio-inline">
                                    <input type="radio" name="tou" value="Employee" required>Employee  
                                </div>
                                <div class="radio-inline">
                                    <input type="radio" name="tou" value="Agent">Agent
                                </div>
                
            </div>
            <div class="form-group">
                <center>
                    <input class="btn btn-glyaphicon" type="submit" value="Submit">
