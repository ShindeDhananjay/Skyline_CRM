    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">Update User Details</h2>
            <div class="text-center" id="popup"></div>
            <br>
            
            <form method="post" action="DisplayUpdateUser_AdminDB.jsp">
                <div class="row">
                <div class="col-sm-3">
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="UpdateUser_UpdateUser_AdminDB.jsp?id=<%=rs.getInt("userid")%>" class="btn btn-success">
