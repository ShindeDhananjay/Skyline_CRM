        ...
        $(document).ready(function(){
            $('#form1').submit(function(e){
                ...
                if(fname==""){
                    ...
                    $(".scost").after('<span class="error">Please Suggested Cost</span>');
                    $(".error").fadeOut(2000);
                    $("#scost").focus();
                }
...
<body>
	...
	<h1 class="main_heading">New Enquiry Form</h1>
	<center>
            <form class="well" id="form1" name="f1" method="post" action="NewEnquiryForm_EmployeeDB_Process.jsp">
			<div class="row">
			...
			<div class="row">
				<div class="form-group col-sm-6">
					<label>Minimum Budget</label><span class="minb"> </span>
                                        <input type="number" name="minb" class="form-control" id="minb">
				</div>
				<div class="form-group col-sm-6">
					<label>Maximum Budget</label><span class="maxb"> </span>
                                        <input type="number" name="maxb" class="form-control" id="maxb">
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-6">
					<label>Select Type Of Property</label> </span>
					...
					<label>Suggested Cost</label><span class="scost"> </span>
                                        <input type="number" name="scost" class="form-control" id="scost">
				</div>
				...
				<div class="form-group col-sm-12">
					<label >Status</label>
                                        <div class="radio-inline">
                                            <input type="radio" name="status" value="Lead" reaquired >Lead
                                        </div>
                                        <div class="radio-inline">
                                            <input type="radio" name="status" value="Follow Up" required>Follow Up
                                        </div>
                                        <div class="radio-inline">
                                            <input type="radio" name="status" value="Not Intrested" required>Not Intrested 
                                        </div>
				</div>
			</div>
