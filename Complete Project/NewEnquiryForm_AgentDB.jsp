...
<body>
	...
	<center>
            <form class="well" id="form1" name="f1" method="post" action="NewEnquiryForm_AgentDB_Process.jsp">
			<div class="row">
			...
			<div class="row">
				...
				<div class="form-group col-sm-12">
					<label >Status</label>
                                        ...
                                        <div class="radio-inline">
                                            <input type="radio" name="status" value="Not Interested" required>Not Inetrested 
                                        </div>
				</div>
			</div>
