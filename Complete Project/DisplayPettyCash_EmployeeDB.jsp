    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">Purchase Entry Details</h2>
            <div class="text-center" id="popup"></div>
            <br>
            <form method="post" action="DisplayPettyCash_EmployeeDB.jsp">
            <div class="row">
                <div class="col-sm-3">
                     <a href="PettyCash_EmployeeDB.jsp" id="addclient_id" ><span>+</span> Add New Petty Cash Entry</a>
                </div>
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="UpdatePettyCash_EmployeeDB.jsp?id=<%=rs.getInt("pid")%>" class="btn btn-success">
                        <span class="glyphicon  glyphicon-pencil"></span> Update</a>
                    </td>
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeletePettyCash_EmployeeDB_Process.jsp?id=<%=rs.getInt("pid")%>" class="btn btn-danger">
