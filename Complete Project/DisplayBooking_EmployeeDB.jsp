  	...
  	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            ...
            function popup_update_func(){
               document.getElementById('popup').innerHTML=" Booking Updated Successfully ....  <i class='fa-solid fa-check'></i>"
               setTimeout("vanish()",2500);
              
            }
            function popup_delete_func(){
               document.getElementById('popup').innerHTML="<span style='color:red;'> Booking Deleted Successfully ....  <i class='fa-solid fa-check'></i>";
               setTimeout("vanish()",2500);
              
            }
            function popup_added_func(){
               document.getElementById('popup').innerHTML=" Booking Added Successfully ....  <i class='fa-solid fa-check'></i>";
               setTimeout("vanish()",2500);
            ...
            if(res==true){
               window.location.href="DeleteBooking_EmployeeDB_Process.jsp";
            }
            else{
               return false;
            } 
    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="DisplayBooking_EmployeeDB.jsp">
            <div class="row">
                <div class="col-sm-3">
                    <a href="Booking_EmployeeDB.jsp" id="addclient_id" ><span>+</span> Add New Booking</a>
                </div>
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            ...
                            sql ="select * from booking where bid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or bamt ='"+fetch_record+"' or entryby ='"+fetch_record+"' or date ='"+fetch_record+"' " ;
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="UpdateBooking_EmployeeDB.jsp?id=<%=rs.getInt("bid")%>" class="btn btn-success">
                        <span class="glyphicon  glyphicon-pencil"></span> Update</a>
                    </td>
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteBooking_EmployeeDB_Process.jsp?id=<%=rs.getInt("bid")%>" class="btn btn-danger">
