...
<%
    ...
    try{
        ...
        int i=st.executeUpdate("update enquiry_agentdb set fname='"+fname+"',lname='"+lname+"',pnum='"+pnum+"',email='"+email+"',minb='"+minb+"',maxb='"+maxb+"',top='"+top+"',scost='"+scost+"',status='"+status+"' where enqid="+idx);
        
%>

<html>
    <body>
        <form method='post' action='DisplayAllEnquiries_AgentDB.jsp' id="myform" >
