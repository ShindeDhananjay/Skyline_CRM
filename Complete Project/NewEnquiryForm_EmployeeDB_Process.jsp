...
<%
    ...
    try{
        ...
        int i=st.executeUpdate("insert into enquiry (fname,lname,pnum,email,minb,maxb,top,scost,status) values ('"+fname+"','"+lname+"','"+pnum+"','"+email+"','"+minb+"','"+maxb+"','"+top+"','"+scost+"','"+status+"')");
...
<html>
    <body>
        <form method='post' action='DisplayAllEnquiries_EmployeeDB.jsp' id="myform" >
