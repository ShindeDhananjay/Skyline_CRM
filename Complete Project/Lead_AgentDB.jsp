       ...
       <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" integrity="sha512-Evv84Mr4kqVGRNSgIGL/F/aIDqQb7xQ2vcrdIwxfjThSH8CSR7PBEakCr51Ck+w+/U6swU2Im1vVX0SVk9ABhg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        ...
        <script>
            ...
            function getconfirmation(){
                ...
                if(res==true){
                    window.location.href="DeleteEnquiry_Lead_AgentDB_Process.jsp";
                }
                else{
                    return false;
                }
    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">Lead Details</h2>
            <div class="text-center" id="popup"></div>
            <br>
            
            
            <form method="post" action="Lead_AgentDB.jsp">
            <div class="row">
                <div class="col-sm-3">
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from enquiry_agentdb where status = 'Lead' order by enqid Desc";
                        }
                        else{
                            sql ="select * from enquiry_agentdb where status='Lead' and (enqid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or minb ='"+fetch_record+"' or maxb ='"+fetch_record+"' or top ='"+fetch_record+"' or scost ='"+fetch_record+"' ) " ;
            ...
            <table class="table table-bordered">
               ...
               %>          
                <tr>
                    ...
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteLead_AgentDB_Process.jsp?id=<%=rs.getInt("ENQID")%>" class="btn btn-danger">
