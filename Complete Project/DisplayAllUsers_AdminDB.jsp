  	...
  	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            ...
            function popup_update_func(){
               document.getElementById('popup').innerHTML=" User Updated Successfully ....  <i class='fa-solid fa-check'></i>"
               setTimeout("vanish()",2500);
              
            }
            function popup_delete_func(){
               document.getElementById('popup').innerHTML="<span style='color:red;'> User Deleted Successfully ....  <i class='fa-solid fa-check'></i>"
               setTimeout("vanish()",2500);
              
            }
            function popup_added_func(){
               document.getElementById('popup').innerHTML=" User Added Successfully ....  <i class='fa-solid fa-check'></i>"
               setTimeout("vanish()",2500);
            }
            ...
            function getconfirmation(){
                ...
                if(res==true){
                    window.location.href="DeleteUser_DisplayAll_AdminDB_Process.jsp";
                }
                else{
                    return false;
                }
    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">USER DETAILS</h2>
            <div class="text-center" id="popup"></div>
            <br>
            
            <form method="post" action="DisplayAllUsers_AdminDB.jsp">
                <div class="row">
                <div class="col-sm-3">
                    <a href="NewUserRegistration_AdminDB.jsp" id="addclient_id" ><span>+</span> Add New User</a>
                </div>
                <div class="col-sm-5" style="margin-bottom:8px;">
                    <input type="text" class="form-control fetchdata" name="search_req_data" placeholder="Search User">
                </div>
                <div>
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            ...
                            sql ="select * from user where userid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or uname ='"+fetch_record+"' or pass ='"+fetch_record+"' or tou ='"+fetch_record+"'" ; 
                        }
                    }
                    else{
                        sql ="select * from user order by USERID Desc";
            ...
            <table class="table table-bordered">
               ...
               %>       
                ...
                <tr>
                    ...
                    <th><%=rs.getString("PASS")%></th>
                    <th><%=rs.getString("TOU")%></th>
                    <td class="text-center">
                        <a href="UpdateUser_DisplayAllUsers_AdminDB.jsp?id=<%=rs.getInt("userid")%>" class="btn btn-success">
                        <span class="glyphicon  glyphicon-pencil"></span> Update</a>
                    </td>
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteUser_DisplayAll_AdminDB_Process.jsp?id=<%=rs.getInt("userid")%>" class="btn btn-danger">
