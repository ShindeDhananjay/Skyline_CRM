    ...
    <head>
  	...
  	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            ...
            if(res==true){
               window.location.href="DeleteBooking_AgentDB_Process.jsp";
            }
            else{
               return false;
            } 
    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="DisplayBooking_AgentDB.jsp">
            <div class="row">
                <div class="col-sm-3">
                    <a href="Booking_AgentDB.jsp" id="addclient_id" ><span>+</span> Add New Booking</a>
                </div>
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="UpdateBooking_AgentDB.jsp?id=<%=rs.getInt("bid")%>" class="btn btn-success">
                        <span class="glyphicon  glyphicon-pencil"></span> Update</a>
                    </td>
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteBooking_AgentDB_Process.jsp?id=<%=rs.getInt("bid")%>" class="btn btn-danger">
