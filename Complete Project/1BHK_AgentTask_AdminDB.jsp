    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">1BHK Details</h2>
            <div class="text-center" id="popup"></div>
            <br>
            <form method="post" action="1BHK_EmployeeTask_AdminDB.jsp">
                <div class="row">
                <div class="col-sm-3">
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from enquiry_agentdb where top='1BHK' order by enqid Desc";
                        }
                        else{
                            sql ="select * from enquiry_agentdb where top='1BHK' and ( enqid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or minb ='"+fetch_record+"' or maxb ='"+fetch_record+"' or top ='"+fetch_record+"' or scost ='"+fetch_record+"' or status ='"+fetch_record+"') " ;
