            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from enquiry_agentdb where status = 'Follow Up' order by enqid Desc";
                        }
                        else{
                            sql ="select * from enquiry_agentdb where status='Follow Up' and (enqid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or minb ='"+fetch_record+"' or maxb ='"+fetch_record+"' or top ='"+fetch_record+"' or scost ='"+fetch_record+"' ) " ;
            ...
            <table class="table table-bordered">
               ...
               %>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteFollowup_AgentDB_Process.jsp?id=<%=rs.getInt("ENQID")%>" class="btn btn-danger">
