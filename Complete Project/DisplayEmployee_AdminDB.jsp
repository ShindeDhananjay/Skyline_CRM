    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">EMPLOYEE DETAILS</h2>
            <div class="text-center" id="popup"></div>
            <br>
            
            <form method="post" action="DisplayEmployee_AdminDB.jsp">
                <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-5" style="margin-bottom:8px;">
                    <input type="text" class="form-control fetchdata" name="search_req_data" placeholder="Search Employee">
                </div>
                <div>
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from user where tou = 'Employee' order by userid desc ";
                        }
                        else{
                            sql ="select * from user where tou='Employee' and ( userid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or uname ='"+fetch_record+"' or pass ='"+fetch_record+"') " ;
