  	...
  	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            ...
            function getconfirmation(){
                ...
                if(res==true){
                    window.location.href="DeleteEnquiry_DisplayAll_AgentDB_Process.jsp";
                }
                else{
                    return false;
                }
    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">Enquiries Details</h2>
            <div class="text-center" id="popup"></div>
            <br>
            
            
            <form method="post" action="DisplayAllEnquiries_AgentDB.jsp">
                <div class="row">
                <div class="col-sm-3">
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from enquiry_agentdb order by enqid Desc";
                        }
                        else{
                            sql ="select * from enquiry_agentdb where enqid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or minb ='"+fetch_record+"' or maxb ='"+fetch_record+"' or top ='"+fetch_record+"' or scost ='"+fetch_record+"' or status ='"+fetch_record+"' " ;
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a  href="UpdateEnquiry_DisplayAll_AgentDB.jsp?id=<%=rs.getInt("ENQID")%>" class="btn btn-success">
                        <span class="glyphicon  glyphicon-pencil"></span> Update</a>
                    </td>
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteEnquiry_DisplayAll_AgentDB_Process.jsp?id=<%=rs.getInt("ENQID")%>" class="btn btn-danger">
