    ...
    <head>
  	...
  	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            ...
            if(res==true){
               window.location.href="DeleteRequest_EmployeeDB_Process.jsp";
            }
            else{
               return false;
            } 
    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="DisplayRequest_EmployeeDB.jsp">
            <div class="row">
                <div class="col-sm-3">
                    <a href="RequestRaise_EmployeeDB.jsp" id="addclient_id" ><span>+</span> Add New Request</a>
                </div>
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from requestraise_employeedb order by rid Desc";
                        }
                        else{
                            sql ="select * from requestraise_employeedb where bid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or bamt ='"+fetch_record+"' or entryby ='"+fetch_record+"' or date ='"+fetch_record+"' " ;
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="UpdateRequest_EmployeeDB.jsp?id=<%=rs.getInt("rid")%>" class="btn btn-success">
                        <span class="glyphicon  glyphicon-pencil"></span> Update</a>
                    </td>
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteRequest_EmployeeDB_Process.jsp?id=<%=rs.getInt("rid")%>" class="btn btn-danger">
