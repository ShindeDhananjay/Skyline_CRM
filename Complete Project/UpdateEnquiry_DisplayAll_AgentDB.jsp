...
<body>
	...
	<center>
            <%
                int idx =Integer.parseInt(request.getParameter("id"));
                  ...
                  try{
                    ...
                    ResultSet rs=st.executeQuery("select * from enquiry_agentdb where enqid="+idx);
            ...
            %>
            <form class="well" id="form1" name="f1" method="post" action="UpdateEnquiry_DisplayAll_AgentDB_Process.jsp">
				...
				<div class="form-group col-sm-12">
					<label >Status</label>
                                        <div class="radio-inline">
                                            <input type="radio" name="status" value="Not Interested" <%= rs.getString("STATUS").equals("Not Intrested")? "checked" : ""%>required >Not Interested 
                                        </div>
                                        <div class="radio-inline">
