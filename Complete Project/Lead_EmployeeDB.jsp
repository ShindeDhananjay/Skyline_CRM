       ...
       <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" integrity="sha512-Evv84Mr4kqVGRNSgIGL/F/aIDqQb7xQ2vcrdIwxfjThSH8CSR7PBEakCr51Ck+w+/U6swU2Im1vVX0SVk9ABhg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        ...
        <script>
            ...
            function getconfirmation(){
                ...
                if(res==true){
                    window.location.href="DeleteEnquiry_Lead_EmployeeDB_Process.jsp";
                }
                else{
                    return false;
                }
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from enquiry where status = 'Lead' order by enqid Desc";
                        }
                        else{
                            sql ="select * from enquiry where status='Lead' and (enqid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or minb ='"+fetch_record+"' or maxb ='"+fetch_record+"' or top ='"+fetch_record+"' or scost ='"+fetch_record+"' ) " ;
               ...
               %>          
                <tr>
                    ...
                    <td class="text-center">
                        <a href="UpdateEnquiry_Lead_EmployeeDB.jsp?id=<%=rs.getInt("ENQID")%>" class="btn btn-success">
                        <span class="glyphicon  glyphicon-pencil"></span> Update</a>
                    </td>
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteEnquiry_Lead_EmployeeDB_Process.jsp?id=<%=rs.getInt("ENQID")%>" class="btn btn-danger">
