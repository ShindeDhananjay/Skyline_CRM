...
<body onload="myfunction()">
	...
	<h1 class="main_heading">AGENT DASHBOARD</h1>
	...
	<div class="container-well">
		...
		<div class="main">
			<center>
				<div class="row">
					<div class="opns">
						<a href="NewEnquiryForm_AgentDB.jsp"><div class="well">Enquiry</div></a>
					</div>
                                        <div class="opns">
                                            <a href="Booking_AgentDB.jsp"><div class="well">Booking</div></a>
					</div>
                                        <div class="opns">
                                            <a href="SalesEntry_AgentDB.jsp"><div class="well">Sales Entry</div></a>
					</div>
                                        <div class="opns">
                                            <a href="RequestRaise_AgentDB.jsp"><div class="well">Request Raise</div></a>
					</div>
					
					<div class="opns">
                                            <a href="FollowUp_AgentDB.jsp"><div class="well">Follow Up</div></a>
					</div>
				...
				<div class="row">
                                        <div class="opns">
                                            <a href="DisplayAllEnquiries_AgentDB.jsp"><div class="well">All Enquiries</div></a>
					</div>
                                        <div class="opns">
                                            <a href="DisplayBooking_AgentDB.jsp"><div class="well">Display Booking</div></a>
					</div>
                                        
					<div class="opns">
                                            <a href="DisplaySalesEntry_AgentDB.jsp"><div class="well">Display Sales</div></a>
					</div>
					
					<div class="opns">
						<a href="DisplayRequest_AgentDB.jsp"><div class="well">Display Request</div></a>
					</div>
                                        <div class="opns">
                                            <a href="Lead_AgentDB.jsp"><div class="well">Lead</div></a>
					</div>
				</div>
			</center>
		</div>
