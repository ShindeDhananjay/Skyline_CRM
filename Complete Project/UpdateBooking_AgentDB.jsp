...
<body>
	...
	<center>
            <%
                int idx =Integer.parseInt(request.getParameter("id"));
                  ...
                  try{
                    ...
                    ResultSet rs=st.executeQuery("select * from booking_agentdb where bid="+idx);
            ...
            <form class="well" id="form1" name="f1" method="post" action="UpdateBooking_AgentDB_Process.jsp">
