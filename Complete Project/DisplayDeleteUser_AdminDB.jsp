  	...
  	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            ...
            function getconfirmation(){
                ...
                if(res==true){
                    window.location.href="DeleteUser_DeleteUser_AdminDB_Process.jsp";
                }
                else{
                    return false;
                }
    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            <h2 class="text-center details-heading">Delete User Details</h2>
            <div class="text-center" id="popup"></div>
            <br>
            <form method="post" action="DeleteUser_AdminDB.jsp">
                <div class="row">
                <div class="col-sm-3">
                    <a href="NewUserRegistration_AdminDB.jsp" id="addclient_id" ><i >+</i> Add New User</a>
                </div>
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a onclick="return getconfirmation()" href="DeleteUser_DeleteUser_AdminDB_Process.jsp?id=<%=rs.getInt("userid")%>" class="btn btn-danger">
