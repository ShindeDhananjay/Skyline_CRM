    ...
    <body onload="myfunction()">
       ...
       <div class="jumbotron brandname">
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="DisplayAllEnquiries_EmployeeDB.jsp">
                <div class="row">
                <div class="col-sm-3">
                    <a href="NewEnquiryForm_EmployeeDB.jsp" id="addclient_id" ><span>+</span> Add New Enquiry</a>
                </div>
            ...
            <%
                    ...
                    if(xbtn!=null){
                        ...
                        if(fetch_record.equals("")){
                            sql ="select * from enquiry order by enqid Desc";
                        }
                        else{
                            sql ="select * from enquiry where enqid ='"+fetch_record+"' or fname ='"+fetch_record+"' or lname ='"+fetch_record+"' or pnum ='"+fetch_record+"' or email ='"+fetch_record+"' or minb ='"+fetch_record+"' or maxb ='"+fetch_record+"' or top ='"+fetch_record+"' or scost ='"+fetch_record+"' or status ='"+fetch_record+"' " ;
               ...
               %>       
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a  href="UpdateEnquiry_DisplayAll_EmployeeDB.jsp?id=<%=rs.getInt("ENQID")%>" class="btn btn-success">
