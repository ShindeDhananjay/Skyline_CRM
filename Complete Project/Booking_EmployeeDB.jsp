        ...
        $(document).ready(function(){
            $('#form1').submit(function(e){
                ...
                if(date==""){
                    ...
                    $(".bamt").after('<span class="error">Please Enter Booking Amount</span>');
                    $(".error").fadeOut(2000);
                    $("#bamt").focus();
                }
...
<body>
	...
	<h1 class="main_heading">Booking Entry Form</h1>
	<center>
          
            <form class="well" id="form1" name="f1" method="post" action="Booking_EmployeeDB_Process.jsp">
			...
			<div class="row">
				...
				<div class="form-group col-sm-6">
					<label>Booking Amount </label> <span class="bamt"></span>
                                        <input type="number" name="bamt"  class="form-control" id="bamt">
				</div>
				<div class="form-group col-sm-6">
