...
<body>
	...
	<center>
            <%
                int idx =Integer.parseInt(request.getParameter("id"));
                  ...
                  try{
                    ...
                    ResultSet rs=st.executeQuery("select * from requestraise where rid="+idx);
            ...
            %>
            <form class="well" id="form1" name="f1" method="post" action="UpdateRequest_AgentDB_Process.jsp">
